...
window.ASTROLOGY_CONFIG = {
  TAROT_DECK: [
    ...
    },
    {
      ...
      name: "高塔 (The Tower)",
      type: "major",
      uprightMeaning: "劇烈震盪、幻象幻滅、破壞後重建、強烈啟示與防線崩解。",
    ...
    },
    {
      ...
      name: "太陽 (The Sun)",
      type: "major",
      uprightMeaning: "無比光明、生命活力、巨大成功、幸福快樂、自信非凡與溫慢真誠。",
  ...
  DIRECTIONS: ["正東方 (喜神照拂)", "東南方 (財氣引流)", "西南方 (和諧人情)", "正北方 (智慧沉澱)"],
  LOCATIONS: ["微風輕拂的挑高露天咖啡座", "散發木質與精油香氣的芳療室", "擺放大量植栽的明亮溫室花房", "俯瞰城市夜景的幽靜景觀草原"],
  TIME_SLOTS: ["07:00 - 09:00 (朝陽初昇，定神期)", "13:00 - 14:30 (正午微醺，思索期)", "19:00 - 21:00 (華燈暗香，沉澱期)", "22:30 - Midnight (星輝入夢，靜修期)"],
  ...
  WEEKLY_WARNING_POOL: [
    {
      ...
      details: "上升處女座有時會陷於雞毛砂皮的完美主義中，導致專案拖延或對合作夥伴產生無端焦慮。記得退後一步，用太陽金牛的宏觀眼光包容瑕疵。"
    },
    {
